...
import ScriptNode, { type ScriptNodeData } from "./components/Nodes/ScriptNode";
import SetVarNode, { type SetVarNodeData } from "./components/Nodes/SetVarNode";
...
const App = () => {
    ...
    const exportGraph = useCallback(() => {
        ...
        // Находим корневую ноду (нода без входящих связей)
        ...
        // Преобразуем ноды в формат экспорта
